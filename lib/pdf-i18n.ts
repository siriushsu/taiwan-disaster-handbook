...
const TEXT: Record<string, [string, string]> = {
  ...
  loc_qr_hint: ['掃 QR 碼可開啟 Google Maps 導航', 'Scan QR code for Google Maps navigation'],
  ...
  qrc_eq_1: ['趴下、掩護、抓緊 — 躲堅固桌下護頭', 'DROP, COVER, HOLD ON — under sturdy table'],
  qrc_eq_2: ['搖晃停止 → 穿鞋、關瓦斯、確認家人', 'Shaking stops → shoes on, gas off, check family'],
  qrc_eq_3: ['戶外：遠離建築物和電線桿，蹲在空曠處', 'Outdoors: away from buildings/poles, crouch in open'],
  qrc_eq_4: ['不進入受損建築，注意餘震', 'Don\'t enter damaged buildings, watch aftershocks'],
  qrc_fire: ['火災', 'Fire'],
  qrc_fire_1: ['大喊「失火了」，按住警器', 'Shout "FIRE!", press alarm'],
  qrc_fire_2: ['低姿勢移動，濕毛巾遮口鼻', 'Stay low, wet towel over mouth/nose'],
  qrc_fire_3: ['摸門把：不燙→開門逃；燙→塞門縫等救援', 'Touch handle: cool → open & go; hot → seal gap, wait'],
  qrc_fire_4: ['不搭電梯，不回頭拿東西', 'NO elevator, NEVER go back for belongings'],
  qrc_air: ['防空警報', 'Air Raid'],
  qrc_air_1: ['長音 90 秒＝警報；短音 30 秒＝解除', '90s tone = alert; 30s tone = all clear'],
  qrc_air_2: ['進入地下室、捷運站、地下停車場', 'Enter basement, MRT station, underground parking'],
  qrc_air_3: ['無地下空間：堅固建築低樓層，遠離窗戶', 'No underground: sturdy building low floor, away from windows'],
  qrc_air_4: ['聽到解除警報才離開掩蔽處', 'Only leave after all-clear signal'],
  qrc_typhoon: ['颱風水災', 'Typhoon & Flood'],
  qrc_ty_1: ['陽台物品移入室內，窗戶貼米字膠帶', 'Move balcony items inside, tape windows'],
  qrc_ty_2: ['充飽行動電源，備妥 72 小時物資', 'Charge power banks, prepare 72hr supplies'],
  qrc_ty_3: ['待在室內遠離窗戶，不外出看風雨', 'Stay indoors away from windows, don\'t go outside'],
  qrc_ty_4: ['淹水時切斷電源，往高處移動', 'If flooding: cut power, move to higher ground'],
  qrc_principle: ['判斷原則', 'Key Principle'],
  qrc_eq_principle: ['就地掩護，震後再離開', 'Shelter in place, evacuate after shaking'],
  qrc_fire_principle: ['往外逃生，不搭電梯', 'Evacuate out, NO elevator'],
  qrc_air_principle: ['往地下移動（捷運站、地下停車場）', 'Go underground (MRT, parking garage)'],
  qrc_ty_principle: ['待在室內，不外出', 'Stay indoors, don\'t go out'],
  qrc_universal: ['通用守則', 'Universal Rules'],
  qrc_uni_1: ['收聽 FM 廣播取得官方指示', 'Listen to FM radio for official instructions'],
  qrc_uni_2: ['不散播未經證實消息', 'Don\'t spread unverified information'],
  qrc_uni_3: ['前往最近避難所或家庭集合點', 'Go to nearest shelter or family meeting point'],
