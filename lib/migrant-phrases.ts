...
export const MIGRANT_PHRASES: MigrantPhrase[] = [
  ...
  },
  {
    ...
    text: {
      ...
      id: "Nomor ARC saya",
      th: "หมายเลขบัตรถิ่นที่อยู่ (ARC) ของฉันคือ",
  ...
  },
  {
    ...
    text: {
      ...
      fil: "Pakikontak ang aming representative office",
    },
  },
  {
  ...
  },
  {
    ...
    text: {
      ...
      th: "ชั่วโมงทำงานของฉันนานเกินไป",
  ...
  },
  {
    ...
    text: {
      ...
      id: "Saya tidak punya tempat untuk tidur",
      th: "ฉันไม่มีที่นอน",
